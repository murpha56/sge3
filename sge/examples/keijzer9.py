...
class Keijzer9():
    ...
    def read_dataset(self):
        ...
        train_range = list(drange(0,101,1))
        ...
        test_range = list(drange(0,101,.1))
    ...
    def evaluate(self, individual):
        ...
        if self.__test_set is not None:
            ...
            test_error = _sqrt_( test_error /self.__RRSE_test_denominator)
...
if __name__ == "__main__":
    import sge
    sge.setup("parameters/keijzer9.yml")
    eval_func = Keijzer9(params['RUN'])
