...
class SymRegPOET():
    ...
    def read_dataset(self):
        ...
        with open('resources/SymRegPOET/SymRegPOET', 'r') as dataset_file:
            for line in dataset_file:
                dataset.append([float(value.strip(" ")) for value in line.split(" ") if value != ""])
        with open('resources/SymRegPOET/SymRegPOET', 'r') as test_file:
...
if __name__ == "__main__":
    import sge
    sge.setup("parameters/SymRegPOET.yml")
    eval_func = SymRegPOET(params['RUN'])
