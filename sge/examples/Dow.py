...
class Dow():
    ...
    def read_dataset(self):
        ...
        with open('resources/Dow/DowNorm_train.txt', 'r') as dataset_file:
            for line in dataset_file:
                dataset.append([float(value.strip(" ")) for value in line.split(" ") if value != ""])
        with open('resources/Dow/DowNorm_test.txt', 'r') as test_file:
...
if __name__ == "__main__":
    import sge
    sge.setup("parameters/Dow.yml")
    eval_func = Dow(params['RUN'])
