...
setwd("/home/aidan/sge3/sge/resources/AusCredit/")

mydf = read.csv(file = "AusCreditFuzzy", sep = ",", stringsAsFactors = FALSE, strip.white = TRUE, colClasses=c('numeric'))
mydf = as.numeric(mydf)

table(mydf$as.numeric.AusCredit.y....1)


N1 = nrow(mydf[mydf$as.numeric.AusCredit.y....1 == 0,])
N2 = nrow(mydf[mydf$as.numeric.AusCredit.y....1 == 1,])
...
write.table(mydf, "AusCreditFinal", append = FALSE, sep = " ", dec = ".",
